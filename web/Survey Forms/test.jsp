                ...
                <div id="Info" class="tabcontent">
                    <div class="container-main">
                        <div class="content-container">
                            ...
                            <div class="table">
                                <div>
                                    <label for="age" class="label-english" class="table-cell">Age&emsp;<span>Edad</span></label>
                                    <select name="age" class="age-select" class="table-cell">
                                ...
                                <div>
                                    ...
                                    <input type="date" placeholder="mm-dd-yyyy" name="birthday" class="table-cell">
                                </div>
                            </div>
                            ...
                            <div >
                                <p class="label-english">Upload ID Picture with Complete Address <br>
                                    ...
                                    <span>I-Upload ang litrato ng ID kung saan makikita ang kumpletong address ng tirahan <br>
                    ...
                    <div class="container-main">
                        ...
                        <div>
                            <p class="label-english">Do you identify as a Person With Disability (PWD)?
                                <br><span> Ikaw ba ay nabibilang sa mga Persons With Disabilities (PWD)?</span></p>
                              <input type="radio" id="pwd" name="pwd" value="pwd">
                              <label for="pwd" class="label-english">Yes&emsp;<span>Oo</span></label><br>
                              <input type="radio" id="pwd" name="pwd" value="pwd">
                              <label for="pwd" class="label-english">No&emsp;<span>Hindi</span></label><br>
                        </div>
                        <br>
                        <div>
                            <label for="typePWD" class="label-english">
                                Type of disability (Type N/A if not applicable)<br>
                                <span>Ano ang uri ng kapansanan? Isulat ang N/A kung wala.</span>
                            </label><br>
                ...
                <div id="Survey" class="tabcontent">
                    <div class="container-main">
                        ...
                        <div>
                            ...
                              <label for="voter" class="label-english">Yes&emsp;<span>Oo</span></label><br>
                              <input type="radio" id="voter" name="voter" value="novoter">
                              <label for="voter" class="label-english">No&emsp;<span>Hindi</span></label><br>
                        </div>
                        <div>
                            ...
                              <label for="org" class="label-english">Yes&emsp;<span>Oo</span></label><br>
                              <input type="radio" id="org" name="org" value="noorg">
                              <label for="org" class="label-english">No&emsp;<span>Hindi</span></label><br>
                        </div>
                        <br>
                        <div>
                        ...
                        <div>
                            ...
                              <label for="proj" class="label-english">Yes&emsp;<span>Oo</span></label><br>
                              <input type="radio" id="noproj" name="proj" value="noproj">
                              <label for="proj" class="label-english">No&emsp;<span>Hindi</span></label><br>
                              <input type="radio" id="proj" name="proj" value="maybeproj">
                              <label for="proj" class="label-english">Maybe&emsp;<span>Hindi Sigurado</span></label><br>
                        </div>
                        <div>
