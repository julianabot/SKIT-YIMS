...
<html>
    <head>
        ...
        <link href="Survey Forms/SurveyCSS/Success.css" rel="stylesheet" type="text/css">
        <title>Success!</title>
    </head>
    <body>
        <!--Header-->
        ...
        <img src="img/SK_Logo.png" alt="SK Logo" id="Logo">
            ...
            <h3 class="bottom-text">You may exit or close this tab or you may go to the <a href="Welcome.jsp" id="redirect-home">Home Page</a>.</h3> <!--Link to Welcome Page-->
            </div>
        </div>
